...
import com.research.apca.algorithm.optimize.common.base.DecisionSpace;
import com.research.apca.algorithm.optimize.common.base.Fitness;
import com.research.apca.algorithm.optimize.common.base.Individual;
import com.research.apca.algorithm.optimize.common.base.Problem;
import com.research.apca.algorithm.optimize.enums.CompareIndividualType;
...
public class ResearchOptimizationProblem extends Problem {
    ...
    public Fitness calculateIndividualFitness(Individual individual) {
        int call=Integer.MAX_VALUE;
        int timeLength = this.project.getTimeUnits().size();
        this.simulation.initializeSimulationModel(0);
        while (call==Integer.MAX_VALUE){
            this.simulation.initializeSimulationModel(call);
            this.simulation.assignSimulation(individual, timeLength);
            call=this.simulation.reverseSimulate();
        }
