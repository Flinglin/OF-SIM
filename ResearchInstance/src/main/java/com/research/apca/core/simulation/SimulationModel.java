package com.research.apca.core.simulation;
...
public abstract class SimulationModel {
    ...
    protected void initializeIntakeEntities(int status) {
    ...
    public void initializeSimulationModel(int status) {
        initializePumpEntities();
        initializeReservoirEntities();
        initializeGateEntities();
        initializeIntakeEntities(status);
