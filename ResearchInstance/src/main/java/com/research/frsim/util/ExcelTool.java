...
public class ExcelTool {
	...
	public static void write07Excel(String path, String sheetName, List<Object[]> data) throws IOException{
		Workbook wb = new XSSFWorkbook();
	    Sheet sheet = wb.createSheet(sheetName);
	    fillSheet(wb, sheet, data);
	    FileOutputStream fileOut = new FileOutputStream(path);
	...
	public static void reWrite07Excel(String path, String sheetName, List<Object[]> data) throws IOException{
		InputStream fis = null;
		try {
			fis = new FileInputStream(path);
		} catch (Exception e) {
	...
	public static void write03Excel(String path, String sheetName, List<Object[]> data) throws IOException{
		Workbook wb = new HSSFWorkbook();
	    Sheet sheet = wb.createSheet(sheetName);
	    fillSheet(wb, sheet, data);
	    FileOutputStream fileOut = new FileOutputStream(path);
	...
	public static void reWrite03Excel(String path, String sheetName, List<Object[]> data) throws IOException{
		InputStream fis = null;
		try {
			fis = new FileInputStream(path);
		} catch (Exception e) {
	...
	protected static void fillSheet(Workbook wb, Sheet sheet, List<Object[]> data){
		CellStyle cellStyle = wb.createCellStyle();
		cellStyle.setDataFormat(wb.getCreationHelper().createDataFormat().getFormat("yyyy-mm-dd hh:mm:ss"));
